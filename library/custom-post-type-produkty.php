...
function custom_post_example2() { 
	...
	register_post_type( 'produkty', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Produkty', 'legabeton'), /* This is the Title of the Group */
			'singular_name' => __('Produkt', 'legabeton'), /* This is the individual type */
			...
			'rewrite'	=> array( 'slug' => 'produkty', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'produkty', /* you can rename the slug here */
	...
	/*register_taxonomy_for_object_type('category', 'produkty');*/
	...
	*/
    ...
    register_taxonomy( 'kategorie-produktu', 
    	array('produkty'), /* if you change the name of register_post_type( 'produkty', then you have to change this */
    	array('hierarchical' => true,     /* if this is true, it acts like categories */             
    		'labels' => array(
    			'name' => __( 'Kategorie produktů', 'legabeton' ), /* name of the custom taxonomy */
    			'singular_name' => __( 'Kategorie produktu', 'legabeton' ), /* single taxonomy name */
