...
function joints_scripts_and_styles() {
  ...
  if (!is_admin()) {
   ...
   //wp_enqueue_script( 'joints-modernizr', get_stylesheet_directory_uri() . '/library/js/vendor/modernizr.js', array(), '2.5.3', false );
    ...
    //wp_enqueue_style( 'foundation-docs', get_stylesheet_directory_uri() . '/library/css/docs.css', array(), '', 'all' );

    wp_enqueue_style( 'custom-stylesheet', get_stylesheet_directory_uri() . '/library/css/custom-style.css', array(), '', 'all' );
