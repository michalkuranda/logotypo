<?php
/* joints Custom zk_klient  Example
...
function custom_post_example9() { 
	// creating (registering) the custom type 
	register_post_type( 'zk_klient', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Zkušenosti klientů', 'legabeton'), /* This is the Title of the Group */
			'singular_name' => __('Zkušenosti klientů', 'legabeton'), /* This is the individual type */
			...
			'rewrite'	=> array( 'slug' => 'zk_klient', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'zk_klient', /* you can rename the slug here */
	...
	/*register_taxonomy_for_object_type('category', 'zk_klient');*/
 
} 

	// adding the function to the Wordpress init
	add_action( 'init', 'custom_post_example9');
