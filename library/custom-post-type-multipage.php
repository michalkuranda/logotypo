<?php
/* joints Custom multipage  Example
...
function custom_post_example3() { 
	// creating (registering) the custom type 
	register_post_type( 'multipage', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Multipage', 'legabeton'), /* This is the Title of the Group */
			'singular_name' => __('Multipage', 'legabeton'), /* This is the individual type */
			...
			'rewrite'	=> array( 'slug' => 'multipage', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'multipage', /* you can rename the slug here */
	...
	/*register_taxonomy_for_object_type('category', 'multipage');*/
 
} 

	// adding the function to the Wordpress init
	add_action( 'init', 'custom_post_example3');
